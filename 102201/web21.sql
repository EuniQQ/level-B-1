...
(1, '回首頁', 'index.php', 1, 0),
(2, '更多消息', 'index.php?do=news', 1, 0),
(5, '管理登入', '?do=login', 1, 0),
(6, '網站首頁', 'index.php', 1, 0);
